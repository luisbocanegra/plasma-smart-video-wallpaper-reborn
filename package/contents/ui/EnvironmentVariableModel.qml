...
Item {
    ...
    readonly property string plasmaEnvFile: StandardPaths.writableLocation(StandardPaths.HomeLocation).toString().substring(7) + "/.config/plasma-workspace/env/luisbocanegra.smart.video.wallpaper.reborn.sh"
    ...
    Component.onCompleted: {
        runCommand.exec("mkdir -p $HOME/.config/plasma-workspace/env/");
        getVars();
    }
}
