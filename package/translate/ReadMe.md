...
* Fill out [`template.pot`](template.pot) with your translations then open a [new issue](https://github.com/luisbocanegra/plasma-smart-video-wallpaper-reborn/issues/new), name the file `spanish.txt`, attach the txt file to the issue (drag and drop).
